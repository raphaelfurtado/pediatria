            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-12">
                ...
                <div class="lg:col-span-8">
                    ...
                    <div class="mt-12 flex flex-wrap gap-2">
                        <span class="text-gray-500 text-sm mr-2 flex items-center">Tags:</span>
                        <a href="#"
                            class="px-4 py-1.5 bg-gray-100 rounded-full text-xs font-semibold text-gray-600 hover:bg-gray-200 transition">Saúde
                            Pública</a>
                        <a href="#"
                            class="px-4 py-1.5 bg-gray-100 rounded-full text-xs font-semibold text-gray-600 hover:bg-gray-200 transition">Infância</a>
                        <a href="#"
                            class="px-4 py-1.5 bg-gray-100 rounded-full text-xs font-semibold text-gray-600 hover:bg-gray-200 transition">Prevenção</a>
                    </div>
                    ...
                    <div class="mt-12 flex justify-between">
                        <a href="#"
                            ...
                            <span
                                ...
                                Anterior</span>
                            <span class="text-sm font-bold text-gray-800 group-hover:text-gray-900">Campanha de
                                Aleitamento Materno 2023</span>
                        </a>
                        <a href="#"
                            ...
                            <span
                                ...
                                →</span>
                            <span class="text-sm font-bold text-gray-800 group-hover:text-gray-900">Congresso Regional
                                de Pediatria 2026</span>
                        </a>
                    </div>
                </div>
                ...
                <div class="lg:col-span-4 space-y-8">
                    ...
                    <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                        <div class="flex items-center justify-between mb-6">
                            ...
                            <a href="#" class="text-xs font-bold text-sopape-blue hover:text-sopape-yellow">Ver tudo</a>
                        </div>
                        <div class="space-y-6">
                            <!-- Item 1 -->
                            <div class="flex items-start group">
                                <div class="w-16 h-16 rounded-lg overflow-hidden flex-shrink-0 bg-gray-200">
                                    <img class="w-full h-full object-cover group-hover:scale-110 transition duration-300"
                                        src="https://images.unsplash.com/photo-1584515933487-9dca9e86c068?ixlib=rb-1.2.1&auto=format&fit=crop&w=200&q=80"
                                        alt="Thumb">
                                </div>
                                <div class="ml-4">
                                    <span class="text-[10px] font-bold text-sopape-blue uppercase">Vacinação</span>
                                    <h5
                                        class="text-sm font-bold text-gray-800 leading-snug group-hover:text-sopape-blue transition mb-1 line-clamp-2">
                                        <a href="#">Novas diretrizes para vacina da gripe em 2026</a>
                                    </h5>
                                    <span class="text-xs text-gray-400">10 Out, 2025</span>
                                </div>
                            </div>
                            <!-- Item 2 -->
                            <div class="flex items-start group">
                                <div class="w-16 h-16 rounded-lg overflow-hidden flex-shrink-0 bg-gray-200">
                                    <img class="w-full h-full object-cover group-hover:scale-110 transition duration-300"
                                        src="https://images.unsplash.com/photo-1544161515-4ab6ce6db874?ixlib=rb-1.2.1&auto=format&fit=crop&w=200&q=80"
                                        alt="Thumb">
                                </div>
                                <div class="ml-4">
                                    <span class="text-[10px] font-bold text-blue-500 uppercase">Eventos</span>
                                    <h5
                                        class="text-sm font-bold text-gray-800 leading-snug group-hover:text-sopape-blue transition mb-1 line-clamp-2">
                                        <a href="#">Resumo do Simpósio de Pediatria do Norte</a>
                                    </h5>
                                    <span class="text-xs text-gray-400">25 Out, 2025</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <a href="#"
                                class="px-3 py-1 bg-gray-100 hover:bg-gray-200 text-xs text-gray-600 rounded-md transition border border-gray-200">Saúde
                                Infantil</a>
                            <a href="#"
                                class="px-3 py-1 bg-gray-100 hover:bg-gray-200 text-xs text-gray-600 rounded-md transition border border-gray-200">Eventos</a>
                            <a href="#"
                                class="px-3 py-1 bg-gray-100 hover:bg-gray-200 text-xs text-gray-600 rounded-md transition border border-gray-200">Notícias</a>
                            <a href="#"
                                class="px-3 py-1 bg-gray-100 hover:bg-gray-200 text-xs text-gray-600 rounded-md transition border border-gray-200">Vacinação</a>
                            <a href="#"
                                class="px-3 py-1 bg-gray-100 hover:bg-gray-200 text-xs text-gray-600 rounded-md transition border border-gray-200">Artigos
                                Científicos</a>
                            <a href="#"
                                class="px-3 py-1 bg-gray-100 hover:bg-gray-200 text-xs text-gray-600 rounded-md transition border border-gray-200">Nutrição</a>
                        </div>
                    </div>
                    ...
                    <div class="bg-sopape-yellow p-8 rounded-2xl text-center shadow-lg relative overflow-hidden">
                        <div class="relative z-10">
                            ...
                            <h4 class="font-bold text-gray-900 text-lg mb-2">Receba novidades</h4>
                            <p class="text-sm text-gray-800 mb-6 opacity-80">Inscreva-se para receber atualizações da
                                SOPAPE</p>
                            <button
                                class="w-full bg-black text-white font-bold py-3 rounded-lg hover:bg-gray-800 transition">Inscrever-se</button>
                        </div>
                        <!-- Circle Decor -->
